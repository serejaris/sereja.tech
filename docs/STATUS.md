...
| 2026-09-03 | M20 Astra access-angle correction | `content/blog/gpt-6-astra.md`, `README.md`, `docs/PLAN.md`, `docs/STATUS.md`; issue `#171` | five title critics; style and structural gates; Hugo build; Playwright browser review at 840×480 | selected title states the Day One access question and removes the premature migration framing | ship through a corrective PR and replace the queued Telegram announcement |
