...
| 2026-09-03 | M20 GPT-6 Astra release article | `content/blog/gpt-6-astra.md`, `static/images/blog/gpt-6-astra*`, `static/design-review/gpt-6-astra-*`, `layouts/blog/paper.html`, `README.md`, `docs/PLAN.md`, `docs/STATUS.md`; issue `#171` | Grok CLI X research; five deaify critics; fact, persona, and editorial gates; style and structural gates; `hugo --gc --minify`; rendered metadata and media assertions; full SEO helper stack; Playwright browser review at 840×480 | pass locally: article contains 12 attributed source images, official OpenAI video, a local user-made Astra game video, direct Day One verdict, FAQ schema, trailing-slash canonical, and a corrected tag-link template for redirect-source audits | review PR and its updated 840×480 frames before publication |
