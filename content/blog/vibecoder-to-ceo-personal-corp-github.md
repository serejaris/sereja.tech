...
Я решил запустить предзапись на Personal Corp — формат "компания одного человека с агентами". Нужен был бот-флоу: deeplink, обработчик в Telegram-боте, сегмент для рассылок, terminal-стиль экран с текстом.
