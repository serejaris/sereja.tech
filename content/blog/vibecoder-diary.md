...
tags: ["claude code"]
section: AI
image: /images/blog/vibecoder-diary-preview.png
---
...
- [Пайплайн для статей: 5 фаз](/blog/blog-post-pipeline/) — как устроен процесс от темы до публикации, шаг за шагом
- [Software for One: софт, который нужен только тебе](/blog/software-for-one-personal-tools/) — та же идея: строить под себя, не под массовый рынок
