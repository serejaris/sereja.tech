...
| OMP, Cline, OpenCode | ещё дописывали на момент публикации | пока нет |

Выдумывать остальным трём размеры и время не стану. Обновлю таблицу, когда прогоны финишируют.
