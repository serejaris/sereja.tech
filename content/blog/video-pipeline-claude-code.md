---
title: "Видео-пайплайн на Claude Code: от записи до YouTube"
date: 2026-01-14
...
- [Программные видео: Remotion для вайбкодера](/blog/remotion-programmatic-video-vibecoding/) — когда видео собирается не через монтажку, а через React-компоненты
- [UX видео-уроков: что реально работает](/blog/video-lesson-ux/) — как делать учебное видео понятным, а не просто автоматическим
- [MIDI + OBS + Claude Code: физический пульт для стримов](/blog/midi-obs-claude-code/) — ещё один пример автоматизации медиа-рутины через агента
- [Голосовой ассистент на Claude Code](/blog/claude-code-voice-assistant/) — управление агентом голосом, когда клавиатура мешает процессу
