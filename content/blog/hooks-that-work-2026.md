...
- [Дневник вайбкодера: каждая сессия — статья](/blog/vibecoder-diary/) — как выстроить поток статей, чтобы было что хукировать
- [Пайплайн для статей: 5 фаз](/blog/blog-post-pipeline/) — структура процесса, в которую хук встраивается на первом этапе
