...
- [MapReduce для субагентов: 12800 строк без потери контекста](/blog/mapreduce-subagents/) — базовый паттерн, который лежит в основе этого pipeline
- [Дайджесты чатов с субагентами и дешёвыми моделями](/blog/digest-subagents-mapreduce/) — аналогичный подход для обработки больших объёмов текста с Haiku на Map-стадии
