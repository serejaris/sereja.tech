...
image: /images/blog/agent-consilium-independent-opinions-preview.png
---
...
- [Аудит персональной OS из трёх AI-сервисов](/blog/personal-os-project-audit/) — пример, где независимые агенты помогают увидеть архитектурную картину
- [Типы приложений: информационное или функциональное](/blog/app-types-guide/) — простой фильтр для обсуждения продукта до кода
- [Fact-checker в AI workflow](/blog/fact-checker-in-ai-workflow/) — проверка фактов после мнений, но до плана работ
