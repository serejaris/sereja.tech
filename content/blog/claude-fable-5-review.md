...
Все эксперименты дня лежат в открытом репозитории [serejaris/claude-fable](https://github.com/serejaris/claude-fable) — каждый проект в своей папке, рядом с оригинальным промптом. Запись стрима — [на YouTube](https://youtube.com/live/eguZQ4MAh8U).
