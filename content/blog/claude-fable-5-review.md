...
Кстати, у Gemini 3.1 Pro есть ниша, где ему нет равных, — [SVG-анимации за один промпт](/blog/gemini-3-1-pro-svg-animations/). Для визуала я держу эту модель в арсенале отдельно, рядом с рабочими Claude.
...
{{< callout type="insight" title="Промпт: рамка сессии" copy="true" >}}
...
{{< callout type="insight" title="Промпт: FPS за 30 минут с деплоем" copy="true" >}}
У тебя есть доступ к Railway. Мне нужно, чтобы ты сделал полноценную онлайн 3D FPS (примитивный low-poly стиль) с комнатами, в духе Counter-Strike 1.6. Арена/карта — de_dust. Это происходит во время стрима, у тебя есть 30 минут, за которые ты должен всё реализовать. В конце я должен дать ссылку зайти в игру — к ней смогут подключиться другие люди, которым я дам ссылку, и мы сможем поиграть несколько раундов. Вначале сформулируй план и зафиксируй его в issue, разбей на подзадачи.
{{< /callout >}}
...
{{< callout type="insight" title="Промпт: декомпозиция голосом" copy="true" >}}
...
{{< callout type="insight" title="Промпт: починить артефакт из claude.ai" copy="true" >}}
...
{{< callout type="insight" title="Промпт: клон Majesty" copy="true" >}}
...
{{< callout type="insight" title="Промпт: Chrome-плагин с отсчётом" copy="true" >}}
