---
title: "AGENTS.md: что это и как подружить Claude Code с Codex"
date: 2026-03-14
description: "Что такое AGENTS.md, зачем он нужен AI-агентам и как сделать один source of truth для Codex, Cursor и Claude Code через тонкий CLAUDE.md."
tags: ["agents-md", "claude-code", "codex", "мультиагентность", "инфраструктура"]
image: /images/blog/agents-md-source-of-truth-preview.png
---

AGENTS.md — файл в корне репозитория, который описывает правила проекта для любого AI-агента: Codex, Cursor, Copilot, Gemini CLI, Aider и других. Если коротко, это README для агентов: один файл, одна правда. 60 000+ репозиториев уже используют его, стандарт поддерживается Linux Foundation и читается нативно двадцатью инструментами. Вот как я внедрил AGENTS.md у себя и решил главную проблему — Claude Code читает не его, а CLAUDE.md.
