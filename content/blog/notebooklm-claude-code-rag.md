...
**MCP-сервер.** MCP (Model Context Protocol) — способ дать агенту доступ к внешним инструментам. Есть готовый [notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp). Подключаешь, и NotebookLM становится ещё одним инструментом агента рядом с Chrome DevTools, Exa и остальными.
