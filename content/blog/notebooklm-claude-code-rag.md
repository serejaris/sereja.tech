...
NotebookLM от Google умеет читать твои документы и отвечать на вопросы с точными цитатами. Бесплатно. Я подключил его к Claude Code, и теперь два AI работают в паре: загружаю записи занятий, PDF, ссылки, спрашиваю на обычном языке, получаю ответы со ссылками на конкретные места в источниках. Я только пишу промпт.
