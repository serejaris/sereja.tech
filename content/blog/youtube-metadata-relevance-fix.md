...
- [Программные видео: Remotion для вайбкодера](/blog/remotion-programmatic-video-vibecoding/) — как автоматизировать не только метаданные, но и сам видеоролик
- [UX видео-уроков: что реально работает](/blog/video-lesson-ux/) — почему структура и главы важнее красивой обложки
- [Telegram API вместо JSON экспорта](/blog/telegram-api-vs-json-export/) — тот же принцип для чатов: брать данные из живого API, а не из ручного экспорта
- [Дайджест одного Telegram-сообщения](/blog/telegram-single-message-digest/) — как аккуратно упаковать результат анализа в один пост
