...
- [Как работать с LLM в 2026: workflow Addy Osmani](/blog/llm-coding-workflow-2026/) — декомпозиция задач, context engineering, git worktrees для параллельных агентов
- [Two-Stage AI Pipeline: платим вдвое меньше](/blog/two-stage-ai-pipeline/) — как разделить extraction и generation, чтобы сократить расходы вдвое
