...
knowledge:
  problem: "Соло-разработчик не замечает дублирование логики между своими проектами и переписывает одно и то же."
  solution: "Два параллельных Explore-агента анализируют проекты и находят повторяющиеся сервисы для извлечения в общие модули."
  pattern: "cross-project-audit"
  tools: ["Claude Code", "Opus 4.6", "Explore-агенты"]
  takeaways:
    - "8 повторяющихся сервисов найдено в 10 проектах за один вечер"
    - "Двухэтапный пайплайн — самый частый паттерн, встречается в 6 из 10 проектов"
    - "20% кода в корпоративных кодбазах — дубликаты (по данным CodeAnt.ai)"
    - "После извлечения сервисов дублирование снижается на 38%, переиспользование растёт на 33%"
    - "6 AI-агентов за 3.5 часа справились с аудитом на 2-3 недели senior-инженера"
  metrics:
    projects_analyzed: 10
    services_found: 8
    duplication_in_codebases_percent: 20
    duplication_reduction_percent: 38
    reuse_increase_percent: 33
  related:
    - slug: "personal-corporation-event-driven-agents"
      relation: "Personal OS — следующий шаг после организации агентов в корпорацию"
---
