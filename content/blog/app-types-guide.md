...
tags: ["разработка", "вайбкодинг"]
section: "Вайбкодинг"
image: /images/blog/app-types-guide-preview.png
---
...
- [Как трекать прогресс студентов на онлайн-курсе с помощью AI](/blog/ai-student-progress-tracking/) — пример функционального приложения, где ценность в действии
- [AI и увольнения в Tailwind: где настоящая проблема](/blog/tailwind-layoffs-ai-impact/) — пример, где важно отделять форму продукта от реального эффекта
