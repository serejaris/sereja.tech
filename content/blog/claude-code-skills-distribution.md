...
section: "Claude Code"
image: /images/blog/claude-code-skills-distribution-preview.png
---
...
Когда коллекция выросла с 15 до ~80 скиллов, появился следующий вопрос — какие из них реально вызываются, а какие висят мёртвым грузом. Решил его [локальным observability-стеком с Grafana](/blog/claude-code-skills-grafana/).
