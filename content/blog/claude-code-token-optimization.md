---
title: "Как перестать сжигать контекст Claude Code впустую"
date: 2026-02-07
...
tags: ["claude code", "оптимизация"]
knowledge:
  problem: "95% контекста Claude Code тратится на результаты инструментов, а не на код или ответы агента"
  solution: "Пять приёмов экономии — новые сессии после двух фейлов, субагенты, конкретные промпты, plan mode и мониторинг через ccusage"
  pattern: "token-context-optimization"
  tools: ["Claude Code", "ccusage", "Python"]
  takeaways:
    - "95.5% контекста — результаты тулов, 4% текст агента, 0.5% код в ответах"
    - "22 сессии и 920 вызовов инструментов за день сожгли ~616K токенов"
    - "Правило двух фейлов: /clear после двух ошибок подряд дешевле дебага"
    - "Сокращение CLAUDE.md с 800 до 150 токенов экономит 32K за 50 промптов"
    - "Output styles и verbose:false оптимизируют 4%, а не 95% контекста"
  metrics:
    sessions_per_day: 22
    tool_calls: 920
    tokens_per_day: 616000
    tool_results_percent: 95.5
  related:
    - slug: "two-stage-ai-pipeline"
      relation: "тот же принцип двухэтапной обработки для экономии токенов"
    - slug: "fix-once-rule-forever"
      relation: "plan mode помогает не повторять ошибки агента"
---
