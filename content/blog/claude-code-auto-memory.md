...
tags: ["claude code"]
image: /images/blog/claude-code-auto-memory-preview.png
---
...
- [Аудит персональной OS из трёх AI-сервисов](/blog/personal-os-project-audit/) — как память агента помогает не терять архитектурные решения между проектами
- [Claude Code logs как статус проекта](/blog/claude-code-logs-project-status/) — как превращать историю команд в управляемый project state
- [Хуки, которые реально работают в 2026](/blog/hooks-that-work-2026/) — автоматизация контекста до того, как агент начнёт отвечать
