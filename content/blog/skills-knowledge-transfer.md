...
date: 2026-02-01
description: "Полтора часа объяснял агенту сегментацию во втором боте — хотя делал её в первом. Скиллы выносят опыт из проекта: описал процесс один раз, работает везде."
tags: ["claude code", "skills"]
image: /images/blog/skills-knowledge-transfer-preview.png
---
