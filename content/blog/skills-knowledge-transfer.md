...
knowledge:
  problem: "Опыт застревает в одном проекте и приходится заново объяснять агенту одни и те же вещи"
  solution: "Упаковать экспертизу в переносимые скиллы — markdown-файлы с чеклистами, паттернами и типичными ошибками"
  pattern: "reusable-agent-skills"
  tools: ["Claude Code", "Agent Skills"]
  takeaways:
    - "Первый скилл — 4 часа инвестиции, второе использование — 30 минут, третье — 15 минут"
    - "Скилл содержит 4 секции: триггеры, чеклист, паттерны, типичные ошибки"
    - "Глобальные скиллы хранятся в ~/.claude/skills/, проектные — в .claude/skills/"
    - "Формат открытый — работает в VS Code с Copilot, в Codex, в API"
  metrics:
    first_project_hours: 4
    second_project_minutes: 30
    third_project_minutes: 15
---
