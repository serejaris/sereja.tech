...
image: /images/blog/two-stage-ai-pipeline-preview.png
---
...
- [Haiku, Sonnet, Opus: какую модель ставить субагенту](/blog/subagent-model-cost/) — как выбирать модель под задачу и не переплачивать
- [Structured Output: почему текстовые промпты — это хрупко](/blog/structured-output-llm/) — Pydantic-схемы для гарантированного формата между этапами пайплайна
