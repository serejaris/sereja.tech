...
- [Как научить Claude Code управлять твоим Chrome](/blog/chrome-devtools-mcp-setup/) — MCP-интеграция, которая даёт агенту прямой доступ к браузеру
- [Как я делаю карточки для Telegram-каруселей без Figma](/blog/carousel-cards-playwright/) — Playwright для генерации изображений, а не только тестов
