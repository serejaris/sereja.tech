---
title: "Убираем аишность: параллельные критики вместо rewriter"
date: 2026-01-11
...
- [MapReduce для субагентов: 12800 строк без потери контекста](/blog/mapreduce-subagents/) — тот же паттерн параллельных Task-вызовов, но для обработки файлов, а не текста
- [Консилиум: три агента нашли разные проблемы](/blog/agent-consilium-independent-opinions/) — похожий подход, только критики оценивают решения, а не стиль текста
