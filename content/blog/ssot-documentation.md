---
title: "Один источник правды: почему нельзя копировать данные"
date: 2026-01-12
...
- [Документируй разговоры с агентом, а не код](/blog/document-conversations-not-code/) — как перестать дублировать информацию и сделать диалог первичным артефактом
- [AGENTS.md: дружим Claude Code с Codex](/blog/agents-md-source-of-truth/) — один файл как источник правды для всех AI-агентов в проекте
