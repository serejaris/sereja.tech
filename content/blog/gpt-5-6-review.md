...
date: 2026-07-09
description: "Обзор GPT-5.6 после стрима: Sol ставит задачи агентам, Ultra сам собирает команду. Но «готовая» по отчёту страница сломана в браузере — приёмка за мной."
tags: ["GPT-5.6", "Codex", "AI-агенты", "оркестрация", "вайбкодинг"]
youtube_id: "B1zEAJC6OdU"
image: "/images/blog/gpt-5-6-review-preview.webp"
cta: none
cta_reason: "обзор релиза без прямой продуктовой связки"
---

[Fable уже задала для меня планку оркестрации](/blog/claude-fable-5-review/): сама собирала команды агентов и запускала двухфазную критику. На стриме GPT-5.6 этот сценарий появился и в GPT-стеке. В Ultra команда подключилась самостоятельно, а в OMP Sol хорошо ставила агентам задачи. После эфира я оставил её основной моделью в этом стеке.
...
![Три версии лендинга Personal Corp, созданные моделями GPT-5.6 Sol, Terra и Luna](/images/blog/gpt-5-6-sol-terra-luna.webp)
...
![Интерактивная Солнечная система, созданная Sol во время стрима](/images/blog/gpt-5-6-solar-system.webp)
...
![Dust Arena после итерации Sol на момент стрима](/images/blog/gpt-5-6-dust-arena-stream.webp)
