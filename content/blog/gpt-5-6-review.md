...
[Fable уже задала для меня планку оркестрации](/blog/claude-fable-5-review/): сама собирала команды агентов и запускала двухфазную критику. На стриме этот сценарий появился и в GPT-стеке. В Ultra команда подключилась самостоятельно, а в OMP Sol хорошо ставила агентам задачи. После эфира я оставил её основной моделью в этом стеке.
...
<figure>
  <img src="/images/blog/gpt-5-6-sol-terra-luna.webp" alt="Три версии лендинга Personal Corp, созданные моделями GPT-5.6 Sol, Terra и Luna">
  <figcaption>Одна задача, три версии. Слева направо: Sol, Terra и Luna.</figcaption>
</figure>
...
<figure>
  <img src="/images/blog/gpt-5-6-solar-system.webp" alt="Интерактивная Солнечная система, созданная Sol во время стрима">
  <figcaption>Выглядит законченной: планеты, карточка Земли и управление скоростью. Проблема обнаружилась только после живой проверки.</figcaption>
</figure>
...
<figure>
  <img src="/images/blog/gpt-5-6-dust-arena-stream.webp" alt="Dust Arena после итерации Sol на момент стрима">
  <figcaption>Версия на момент стрима: командный счёт уже появился, мини-карты и видимой границы тумана войны ещё нет.</figcaption>
</figure>
