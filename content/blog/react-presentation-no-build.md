...
Позже на таком же деке я поднял [live-whiteboard с синхронизацией на iPad](/blog/svoy-miro-za-30-minut/) — рисование по слайдам через WebSocket, без Miro и Excalidraw в соседнем табе.
