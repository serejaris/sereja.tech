---
title: "Clawdbot: личный AI-ассистент с дырой в безопасности"
date: 2026-01-26
...
image: /images/blog/clawdbot-personal-ai-assistant-preview.png
---
...
- [Локальный RAG на M1: эмбеддинги без облака](/blog/local-rag-embeddings-m1/) — что происходит, когда личному ассистенту нужна локальная память
- [Moltbook: социальная сеть для AI-агентов](/blog/moltbook-social-network-ai-agents/) — похожая идея агентского интерфейса, но уже на уровне социальной сети
