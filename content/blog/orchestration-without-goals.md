...
Для разработки продукта этот порядок разобран в [гайде по циклу работы с агентами](/blog/sdlc-agent-cycle/): от постановки задачи с критериями приёмки до проверки и публикации. Внутри есть схемы и шаблоны постановки задач.
