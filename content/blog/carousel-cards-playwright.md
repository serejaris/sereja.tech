...
tags: ["claude-code", "playwright", "автоматизация", "контент"]
---

Нужны были карточки для поста о восьмом потоке школы. Шесть штук, квадратные, в едином стиле.
...
Для школы такие карточки нужны постоянно — анонсы потоков, расписание, результаты учеников. Хотел один раз настроить шаблон и менять только текст.
