...
knowledge:
  problem: "AI-агенты не помнят исправления между сессиями и повторяют одни и те же ошибки."
  solution: "Записывать каждую повторяющуюся ошибку как правило в файлы CLAUDE.md, .cursor/rules/ или AGENTS.md."
  pattern: "fix-once-rule-forever"
  tools: ["Claude Code", "Cursor", "Windsurf", "AGENTS.md"]
  takeaways:
    - "Через полгода накапливается ~50 правил, каждое из конкретной ошибки"
    - "AGENTS.md используют 60 000 репозиториев на GitHub как универсальный формат"
    - "Правила с paths: загружаются только для релевантных файлов"
    - "Агент сам предлагает правила в конце сессии — бесплатная обратная связь"
    - "Контекст Claude Code — 200K токенов, из них 45K зарезервировано под буфер"
  related:
    - slug: "draft-before-artifact"
      relation: "черновик как предварительный этап перед созданием правил"
---
