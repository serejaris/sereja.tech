...
- [TUI-презентация прямо в Claude Code](/blog/tui-presentation-claude-code/) — ещё один способ использовать терминал вместо GUI-инструментов
- [Один скрипт вместо трёх терминалов](/blog/dev-script-health-checks/) — как держать сервисы под контролем, чтобы было что показывать в дашборде
