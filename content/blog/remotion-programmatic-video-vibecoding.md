...
- [Пайплайн видео через Claude Code](/blog/video-pipeline-claude-code/) — практический пример, где агент собирает видео из детерминированных шагов
- [MIDI + OBS + Claude Code: физический пульт для стримов](/blog/midi-obs-claude-code/) — управление видеопроцессом через железный интерфейс и агента
- [UX видео-уроков: что реально работает](/blog/video-lesson-ux/) — как думать о структуре ролика до автоматизации рендера
