...
- [Один JSON кормит всех: как строить data layer для агентов](/blog/data-layer-for-agents/) — как структурировать общее состояние между агентами, что критично для A2A-коммуникации
- [Agent Teams в Claude Code: команда агентов за 5 минут](/blog/agent-teams-opus-4-6/) — практический старт с командой агентов до того, как строить собственную сеть
