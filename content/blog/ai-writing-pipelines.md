...
Такой конвейер AI-контента — выпускной проект каждого студента в [кружке вайбкодинга](https://t.me/ris_ai/550). Следующий поток стартует **6 марта**. [Подробности и запись →](https://t.me/ris_ai/550)
{{< /callout >}}
...
- [MapReduce для субагентов: 12800 строк без потери контекста](/blog/mapreduce-subagents/) — паттерн параллельной обработки, который я использовал при исследовании 88 источников для этой статьи
- [Two-Stage AI Pipeline: платим вдвое меньше](/blog/two-stage-ai-pipeline/) — конкретная реализация разделения дорогой и дешёвой модели внутри конвейера
