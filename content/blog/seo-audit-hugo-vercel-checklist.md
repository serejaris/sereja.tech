...
{{< callout insight >}}
а мне нужно сабмитить sitemap? проведи комплексное исследование на предмет лучших практик для этой проблемы используя exa mcp
{{< /callout >}}
...
Починил через Vercel Dashboard: Domains → выбрать redirect type → 308 Permanent. Одна настройка, две минуты.
