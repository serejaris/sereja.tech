...
Распределение моделей входит в общий [цикл разработки с агентами](/blog/sdlc-agent-cycle/): постановка задачи, план, код, тесты, приёмка и публикация. В гайде есть промпт оркестратора с выбором модели исполнителя.
