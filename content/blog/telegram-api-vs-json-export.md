...
- [Автопостер для Telegram](/blog/telegram-autoposter/) — автоматизация на другом конце: не читать чаты, а публиковать в канал
- [Семантический поиск по Telegram](/blog/telegram-vector-search/) — следующий шаг после API: поиск по смыслу в накопленных сообщениях
