...
- [Хуки, которые реально работают в 2026](/blog/hooks-that-work-2026/) — практические паттерны хуков в агентском workflow
- [Claude Code logs как статус проекта](/blog/claude-code-logs-project-status/) — зачем сохранять историю команд как проектный артефакт
- [Голосовой ассистент на Claude Code](/blog/claude-code-voice-assistant/) — другой способ управлять агентом без ручной рутины
- [Clawdbot: Claude Code с телефона через Telegram](/blog/clawdbot-telegram-max/) — мессенджерный интерфейс к агенту вместо локального терминала
