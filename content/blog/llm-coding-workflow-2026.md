...
Для рутины с большими объёмами токенов есть ещё [Kimi K2.5](/blog/kimi-k2-5-agentic-model/) — китайская модель с 256K контекстом и ценой в пять раз ниже Claude. На Humanity's Last Exam она обошла GPT-5.2 и Claude Opus 4.5.
...
- [Запускаю context.lat: почему половина из 90 минут — не код](/blog/context-lat-90-minutes/) — практический пример, где планирование заняло больше времени, чем генерация
