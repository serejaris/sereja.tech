...
- [Evals: автоматическая проверка качества AI-агентов](/blog/llm-evals-for-vibecoder/) — как не угадывать, а измерять качество работы агента
- [Дневник вайбкодера: каждая сессия — статья](/blog/vibecoder-diary/) — превращать работу с агентом в накопленный контент, а не только в результат
- [Персонализированное обучение: данные студентов для AI](/blog/personalized-teaching-student-data/) — какие поля хранить до того, как начинаешь трекать прогресс
- [Типы приложений: информационное или функциональное](/blog/app-types-guide/) — как не перепутать LMS-дашборд с настоящим учебным инструментом
