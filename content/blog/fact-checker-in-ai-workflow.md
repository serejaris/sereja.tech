...
date: 2026-01-11
description: "Похвалил в статье Gemini 2.0 Flash — модель устарела на год. Добавил четвёртого критика-фактчекера: флагает версии и даты, Exa проверяет их по вебу."
tags: ["fact-checking", "llm"]
section: "AI"
...
- [Как устроены конвейеры AI-контента: 12 паттернов](/blog/ai-writing-pipelines/) — deaify с фактчекером вписывается в паттерн Self-Refine; там объяснено почему это работает
- [Two-Stage AI Pipeline: платим вдвое меньше](/blog/two-stage-ai-pipeline/) — Critic D на Haiku, Exa-верификация на Sonnet: именно такое разделение по стоимости
