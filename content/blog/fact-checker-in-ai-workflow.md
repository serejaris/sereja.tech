...
section: "AI"
knowledge:
  problem: "AI-критики проверяют стиль и ритм текста, но пропускают устаревшие факты — версии моделей, даты, названия."
  solution: "Добавить четвёртого критика (Critic D) для проверки версий и дат с последующей веб-проверкой через Exa."
  pattern: "fact-checker-critic"
  tools: ["Claude Code", "Exa", "deaify-text"]
  takeaways:
    - "4 критика запускаются параллельно — время обработки не увеличилось"
    - "Веб-проверка добавляет 2-3 секунды на утверждение, ~20 секунд на статью"
    - "Модели устаревают за 6 месяцев — Gemini 2.0 Flash заменён на Gemini 3 Flash"
    - "GPT-4/o1/o3 заменены на GPT-5 с встроенным режимом рассуждений"
  metrics:
    critics_count: 4
    web_check_seconds_per_claim: 3
    total_overhead_seconds: 20
---
