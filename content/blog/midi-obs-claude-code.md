...
- [Claude Code — напарник, Codex — исполнитель](/blog/claude-code-vs-codex-cli/) — чем Claude Code отличается от других агентов при отладке таких задач
- [Software for One: софт, который нужен только тебе](/blog/software-for-one-personal-tools/) — MIDI-контроллер для OBS — хороший пример инструмента, который нужен только тебе
