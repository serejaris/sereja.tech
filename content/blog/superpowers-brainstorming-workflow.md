...
Сначала полезно пройти [живой прогон по рецепту, а уже потом автоматизировать](/blog/pipeline-born-by-hand/): так план остаётся проверяемым, а делегирование — управляемым.
...
- [Fact-checker в AI workflow](/blog/fact-checker-in-ai-workflow/) — как не превращать brainstorming в уверенные галлюцинации
- [Хуки, которые реально работают в 2026](/blog/hooks-that-work-2026/) — как добавить агенту дисциплину через события, а не через просьбы
- [AI и увольнения в Tailwind: где настоящая проблема](/blog/tailwind-layoffs-ai-impact/) — пример, где без проверки фактов легко сделать неверный вывод
