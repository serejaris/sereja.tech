...
**Plan — это промпт для агентов.** Результат brainstorming — готовый промпт, который передаётся агентам в новую сессию. Они выполняют задачи по порядку, с полным контекстом, без потери фокуса.
