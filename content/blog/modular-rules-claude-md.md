...
- [AGENTS.md: дружим Claude Code с Codex](/blog/agents-md-source-of-truth/) — универсальный формат правил, который работает в нескольких агентах сразу
- [Правка → Правило: как научить агента не повторять ошибки](/blog/fix-once-rule-forever/) — паттерн наполнения rules/ через реальные ошибки
